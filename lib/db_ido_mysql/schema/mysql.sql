...
CREATE TABLE IF NOT EXISTS icinga_conninfo (
  ...
  last_checkin_time timestamp  default current_timestamp,
  data_start_time timestamp  default current_timestamp,
  data_end_time timestamp  default current_timestamp,
...
CREATE TABLE IF NOT EXISTS icinga_contactstatus (
  ...
  host_notifications_enabled smallint default 0,
  service_notifications_enabled smallint default 0,
  last_host_notification timestamp  default current_timestamp,
  last_service_notification timestamp  default current_timestamp,
...
CREATE TABLE IF NOT EXISTS icinga_downtimehistory (
  ...
  scheduled_start_time timestamp  default current_timestamp,
  scheduled_end_time timestamp  default current_timestamp,
...
CREATE TABLE IF NOT EXISTS icinga_hoststatus (
  ...
  last_hard_state_change timestamp  default current_timestamp,
  last_hard_state smallint default 0,
  last_time_up timestamp  default current_timestamp,
  last_time_down timestamp  default current_timestamp,
  last_time_unreachable timestamp  default current_timestamp,
  state_type smallint default 0,
  last_notification timestamp  default current_timestamp,
  next_notification timestamp  default current_timestamp,
...
CREATE TABLE IF NOT EXISTS icinga_logentries (
  ...
  instance_id bigint unsigned default 0,
  logentry_time timestamp  default current_timestamp,
  entry_time timestamp  default current_timestamp,
  entry_time_usec  int default 0,
...
CREATE TABLE IF NOT EXISTS icinga_programstatus (
  ...
  status_update_time timestamp  default current_timestamp,
  program_start_time timestamp  default current_timestamp,
  program_end_time timestamp  default current_timestamp,
  ...
  last_command_check timestamp  default current_timestamp,
  last_log_rotation timestamp  default current_timestamp,
  notifications_enabled smallint default 0,
  disable_notif_expire_time timestamp default current_timestamp,
...
CREATE TABLE IF NOT EXISTS icinga_servicestatus (
  ...
  last_hard_state_change timestamp  default current_timestamp,
  last_hard_state smallint default 0,
  last_time_ok timestamp  default current_timestamp,
  last_time_warning timestamp  default current_timestamp,
  last_time_unknown timestamp  default current_timestamp,
  last_time_critical timestamp  default current_timestamp,
  state_type smallint default 0,
  last_notification timestamp  default current_timestamp,
  next_notification timestamp  default current_timestamp,
  no_more_notifications smallint default 0,
