...
CREATE TABLE IF NOT EXISTS icinga_contactstatus (
  ...
  host_notifications_enabled smallint default 0,
  service_notifications_enabled smallint default 0,
  last_host_notification timestamp  default NULL,
  last_service_notification timestamp  default NULL,
...
CREATE TABLE IF NOT EXISTS icinga_hoststatus (
  ...
  next_check timestamp  default NULL,
  check_type smallint default 0,
  last_state_change timestamp  default NULL,
  last_hard_state_change timestamp  default NULL,
  last_hard_state smallint default 0,
  last_time_up timestamp  default NULL,
  last_time_down timestamp  default NULL,
  last_time_unreachable timestamp  default NULL,
  state_type smallint default 0,
...
CREATE TABLE IF NOT EXISTS icinga_logentries (
  ...
  instance_id bigint unsigned default 0,
  logentry_time timestamp  default NULL,
  entry_time timestamp  default NULL,
  entry_time_usec  int default 0,
...
CREATE TABLE IF NOT EXISTS icinga_programstatus (
  ...
  status_update_time timestamp  default NULL,
  program_start_time timestamp  default NULL,
  program_end_time timestamp  default NULL,
  ...
  last_command_check timestamp  default NULL,
  last_log_rotation timestamp  default NULL,
  notifications_enabled smallint default 0,
  disable_notif_expire_time timestamp default NULL,
...
CREATE TABLE IF NOT EXISTS icinga_servicestatus (
  ...
  last_hard_state_change timestamp  default NULL,
  last_hard_state smallint default 0,
  last_time_ok timestamp  default NULL,
  last_time_warning timestamp  default NULL,
  last_time_unknown timestamp  default NULL,
  last_time_critical timestamp  default NULL,
  state_type smallint default 0,
  last_notification timestamp  default NULL,
  next_notification timestamp  default NULL,
  no_more_notifications smallint default 0,
